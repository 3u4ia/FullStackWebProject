            ...
            <div id="myCarousel" className="carousel slide" data-ride="carousel">
                ...
                <div className="carousel-inner" role="listbox">
                    <div className="item active">
                        <a href="https://soundcloud.com/jaydes/sets/ghetto-cupid"><img src="../GhettoCupid.jpg" style="width:29.7%;" className="img-responsive" alt="Ghetto Cupid album cover"/></a>
                        <p className="text-center">Jaydes' Ghetto Cupid is his most recent album and is already one of my favorites. When he goes from grunge depressive like songs "Rose" and "misery",
                            ...
                            under the names <a href="https://soundcloud.com/heartpacing">mandy im so tired</a> and <a href="https://soundcloud.com/jaydes">yen</a></p>
                    ...
                    <div className="item">
                        <a href="https://open.spotify.com/album/4TMb6OY0lzaNQsj6vcg7M8?si=6A6HAJv4TyGNu2dUxSIp6A"><img src="../dontTakeThisSeriousKaystrueno.jpg" style="width:31.75%" className="img-responsive" alt="Kaystrueno's album don't take this serious"/></a>
                        <p className="text-center">I enjoy Kaystrueno as an artist there's not a specific album/song that I like about him.
                            ...
                            He was a big inspiration to more popular artists in the category like Odetari, </p>
                        <div className="carousel-caption">
                    ...
                    <div className="item">
                        <a href="https://open.spotify.com/album/26hWRAaiKiryWc14gP4poa?si=O1eGP87gRhey8Rq81hCFXQ"><img src="../TheLonelyGodAndTheDefectiveVessel.jpg" style="width:29.74%" className="img-responsive" alt="Sorbet's album The Lonely God and the Defective Vessel"/></a>
            ...
            <div className="container text-center">
                ...
                <div className="row">
                    <div className="col-sm-4">
                        <img src="../Lujon.jpg" className="img-responsive" style="width:100%" alt="Image"/>
                        <p>
                            Music has grown to be very click like. In a way your entire personality has to be whoever you're listening
                            to otherwise you're a fake fan especially with newer music.</p>
                    </div>
                    <div className="col-sm-4">
                        <img src="../Sonder.png" className="img-responsive" style="width:100%" alt="Image"/>
                        <p>One thing I dislike is the fact that so many people say that unless you listen to
                    ...
                    <div className="col-sm-4">
                        <div className="well text-info">
                            <p>I hope people can just let people listen to
                                what they want to listen to and be open-minded to other people's opinions</p>
                        </div>
                        <div className="well text-info">
                            <p>Elroi Belete</p>
                        </div>
